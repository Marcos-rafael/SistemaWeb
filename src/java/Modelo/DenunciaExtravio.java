...
public class DenunciaExtravio {
    ...
    public DenunciaExtravio(){
    }

    public DenunciaExtravio(int id, int item, String tipoobjetod, String seried, String descripciond, String cedula, String nombre, String apellido, String nacionalidad, String estadocivil, String edad, String profesion, String direccion, String departamento, String ciudad, String barrio, String telefono, String fecha_hecho, String hora_hecho, String fecha_denuncia, String direccion_hecho, String firma) {
        this.id = id;
        this.item = item;
